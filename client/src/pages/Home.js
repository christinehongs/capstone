  ...
  return (
    <Box css={homeStyles}>
      ...
      <Box css={wrapper} height="700px" p={5}>
        {/*form box*/}
        <Box background="#DFE7FD" minWidth="800px" height="100%" mx={4} padding="1rem">
          {/*name box*/}
          ...
          <Box border="2px solid black" borderRadius="8px" mb="20px">
            <FormControl padding="1rem">
              <FormLabel htmlFor='country'>I want to see how much my groceries cost in:</FormLabel>
              <Select id='country' placeholder='Select country'>
          ...
          <Box textAlign="center" mb="20px">
            <Button colorScheme='teal' variant='solid' margin="0 auto" px="3rem">
              Let's go!
            </Button>
          </Box>
          {/*check out all the items button*/}
          <Box border="2px solid black" borderRadius="8px" mb="20px" padding="1rem" backgroundColor="#cddafd">
